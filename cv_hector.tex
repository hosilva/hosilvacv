...
Am M\"uhlenberg 1, Potsdam, D-14476\\
Potsdam, Germany
\\ \\
...
\item[]
     ...
     November 2020 -- \emph{Ongoing}
        \begin{innerlist}
        \item Position: Junior Scientist / Leibniz fellow
        \item Supervisor:
...
\item[] M.Sc.,
        ...
        \item Supervisors and relativistic astrophysics:
...
\item co-PI of the \emph{2021 Illinois Blue Waters allocation} project entitled
      ...
      \$427,387). (Starting January 1, 2021).
...
\section{Refereed Journal Publications}
	...
	As of October 2022, my publications have gathered a total of 2881 citations and I have a
    \emph{h-index} of 23 according to the inSpire database. Published work \emph{since 2020} includes
    {\color{aeired}{four}} papers in Physical Review Letters and {\color{aeired}{one}} in the Astrophysical Journal Letters.
    For the most up-to-date publication record see my
    \href{http://inspirehep.net/author/profile/H.O.Silva.1}{profile} in
    inSpire.
...
\begin{bibenum}
    ...
    [\href{https://arxiv.org/abs/2205.05132}{arXiv:2205.05132}] (in review in \emph{Physical Review D})

    \item D. D. Doneva, F. M. Ramazano\u{g}lu, H. O. Silva, T. P. Sotiriou, and S. S. Yazadjiev
    \emph{Scalarization}
    [\href{https://arxiv.org/abs/2211.01766}{arXiv:2211.01766}] (in review in \emph{Reviews of Modern Physics})
\end{bibenum}
...
\begin{bibenum}
    ...
    with neutron stars},
    \invited{} seminar at Universiteit Utrecht in Utrecht, Nederlands,
    (21/10/2021).
    ...
    \invited{} seminar at \href{https://sites.google.com/view/antoniodpj/gravbr}{GravBR} webinar series,
    (27/05/2021).
    ...
    \invited{} webinar for the Latin American Webinars on Physics series (09/12/2020).
...
\begin{innerlist}
    ...
    %
    As of October 2022, the account has 1894 followers, many of whom are lay people and physics
    students.
    %
