...
\begin{innerlist}
    ...
    I contribute to the ET OBS Division 8 -- Waveforms. I was the coordinator of
    the section ``Waveforms in alternative theories of gravity'' for the
    Einstein Telescope's Blue Book, that covers the observatory's science
    case.

\end{innerlist}

\section{Refereed Journal Publications}
    As of April 2026, \textbf{I have a total of 53 published \emph{short-author}}
    research papers, \textbf{2} review articles, \textbf{3} papers in conference
    proceedings, \textbf{2} two book chapters, \textbf{3} manuscripts currently under review,
    ...
    of Modern Physics}}.
    %
    My work has gathered a total of \textbf{6,469 citations}, and I have a
    \textbf{\emph{h}-index of 34} according to the INSPIRE database.
    %
...
\begin{itemize}
    \item (Fall 2025) PHYS 325: Classical Mechanics I.
