...
%
\href{http://www.montana.edu}{Montana State University}\\
\href{http://www.montana.edu/xgi/}{eXtreme Gravity Institute}\\
\href{http://www.physics.montana.edu}{Department of Physics}\\
Barnard Hall, Room 202\\
...
{E-mail:} \email{hector.okadadasilva@montana.edu}\\
...
\textbf{Classical gravity and theoretical astrophysics:}
...
\item[] M.Sc.,
        ...
        \begin{innerlist}
        \item Dissertation Title: \emph{Dynamical Casimir effect in 1+1 dimensions}
        \item Supervisors:
...
\item[] B.Sc.,
        ...
        \begin{innerlist}
        \item Thesis Title: \emph{Exact solution for the energy density inside a non-stationary cavity with an arbitrary initial field state and applications}
        \item Supervisor:
        \href{http://lattes.cnpq.br/6642002445572793}{Danilo T. Alves}
        \end{innerlist}
...
\section{Refereed Journal Publications}
	...
	As of March 2019, my publications have gathered a total of 907 citations and I have a
	\emph{h-index} of 14 according to the inSpire database. For the most up-to-date statistics
...
\begin{bibenum}
    ...
    [\href{https://arxiv.org/abs/1903.07779}{1903.07779}]
...
\begin{bibenum}
    ...
    and collaborated with Hajime Sotani. Visit resulted in publication~\ref{itm:pp_fs}.\\
...
\begin{bibenum}
        ...
        Research project: \emph{Neutron stars in massive scalar-tensor gravity}. \\
    ...
    \item \textbf{Tan\'isia de F\'atima de Moraes Cardoso}\\
        ...
        Research project: \emph{Path integrals in quantum mechanics}. \\
        Primary adviser: Silvana Perez. \\
        Period: 2009--2010.

    \item \textbf{Jocivaldo Siqueira da Silva J\'unior}\\
        Undergraduate student in physics, Federal University of Par\'a, Brazil. \\
        Research project: \emph{Casimir Effect: static and dynamical}. \\
...
\vspace{0.25cm}
\begin{innerlist}
    \item \emph{Physical Review D} \dotfill\, (9),
    ...
    \item \emph{International Journal of Modern Physics D} \dotfill\, (2),
...
\begin{innerlist}
    ...
    %
    As of March 2019, the account has 566 followers, many of whom are lay people and physics
    students.
    %
