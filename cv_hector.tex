...
\section{Refereed Journal Publications}
    As of September 2025, \textbf{I have a total of 50 published \emph{short-author}}
    research papers, \textbf{2} review articles, \textbf{3} papers in conference
    proceedings, \textbf{2} two book chapters, \textbf{2} manuscripts currently under review,
    ...
    of Modern Physics}}.
    %
    My work has gathered a total of \textbf{5,456 citations}, and I have a
