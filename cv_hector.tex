...
\section{Refereed Journal Publications}
    ...
    As of February 2024, \textbf{I have a total of 45 published short-author}
    research papers, \textbf{1} topical review, \textbf{3} papers in conference
    proceedings, and \textbf{1} manuscripts currently under review.
    %
    ...
    of Modern Physics}}.
    %
    In total, my work has gathered a total of 3,968 citations, and I have a
    \emph{h}-index of 27 according to the INSPIRE database.
    %
