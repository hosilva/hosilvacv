...
\hspace{-1.25cm}\parbox{1.6\rcollength}{%
...
including gravitational waves. Gravitational waveform modeling.
Tests of gravity in the strong-field regime. Equation of state of neutron stars.
...
\begin{bibenum}
    ...
    \textcolor{Aquamarine}{invited} talk at the workshop \href{https://sites.google.com/view/fundamental-aspects-of-gravity}{``Fundamental aspects of gravity''}, Imperial College London, United Kingdom,
    (11/08/2022).
...
\item \href{https://www.ufplp.org}{Uni\~{a}o dos \'isicos Pa\'ises L\'ingua Portuguesa}.
\end{innerlist}
