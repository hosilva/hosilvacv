...
\section{Refereed Journal Publications}
    As of June 2025, \textbf{I have a total of 48 published \emph{short-author}}
    research papers, \textbf{2} review articles \textbf{3} papers in conference
    proceedings, \textbf{2} two book chapters, \textbf{4} manuscripts currently under review,
    ...
    of Modern Physics}}.
    %
    In total, my work has gathered a total of 5,118 citations, and I have a
    \emph{h}-index of 31 according to the INSPIRE database.
    %
